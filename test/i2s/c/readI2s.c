...
/* Half-full threshold = FIFO_DEPTH/2; the Makefile derives I2S_DMA_BURST_WORDS
 * from the same root variable, so reading that many words per IRQ matches the
 * peripheral's interrupt point exactly. */
#ifndef I2S_DMA_BURST_WORDS
#error "I2S_DMA_BURST_WORDS must be defined by the Makefile"
#endif
#define I2S_HALF_FULL I2S_DMA_BURST_WORDS
