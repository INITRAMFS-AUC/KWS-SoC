...
int main(void) {
    ...
    /* Prime: spin briefly so I2S FIFO can fill and fire the first IRQ.
     * Without this the FIFO may not reach "full" before the main loop
     * checks ring_ready, causing the CPU to race past setup. */
